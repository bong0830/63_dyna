...
set "ROOT=%~dp0"
if not defined CASE_ROOT set "CASE_ROOT=%ROOT%cases"
if not defined CASE_PREFIX set "CASE_PREFIX=user_case_"
if not defined CASE_SUFFIX set "CASE_SUFFIX="
if not defined START_NO set "START_NO=1"
if not defined END_NO set "END_NO=5"
